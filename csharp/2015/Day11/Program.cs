...
public static class Program
{
    ...
    {
        Console.WriteLine($"Part 1: 'abcdefgh' -> '{IncrementPasswordUntilValid("abcdefgh")}' (expected: 'abcdffaa')"); 
        Console.WriteLine($"Part 1: 'ghijklmn' -> '{IncrementPasswordUntilValid("ghijklmn")}' (expected: 'ghjaabcc')");
        string oldPassword = File.ReadAllText("input.txt");
        string newPassword = IncrementPasswordUntilValid(oldPassword);
        Console.WriteLine($"Part 1: '{oldPassword}' -> '{newPassword}'");
        
        Console.WriteLine($"Part 2: '{newPassword}' -> '{IncrementPasswordUntilValid(newPassword)}'");
    }

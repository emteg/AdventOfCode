...
public static class Program
{
    ...
    {
        Part1Sample();
        ushort a = Execute(File.ReadLines("input.txt"), []);
        Console.WriteLine(a);
        Console.WriteLine(Execute(File.ReadLines("input.txt"), [], a));
    }

    private static void Part1Sample()
    {
